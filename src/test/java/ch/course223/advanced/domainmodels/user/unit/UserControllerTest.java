...
public class UserControllerTest {
    ...
    @Test
    @WithMockUser
    public void create_deliverUserDTOToCreateWithInvalidEmail_returnBadRequest() throws Exception {
        UserDTO userDTOToBeTestedAgainstInvalidEmail = userDTOToBeTestedAgainst;
        ...
        ArgumentCaptor<User> userArgumentCaptor = ArgumentCaptor.forClass(User.class);
        verify(userService, never()).save(userArgumentCaptor.capture());
    }
