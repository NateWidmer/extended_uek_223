...
public class UserRepositoryTest {
    ...
    1 -> From the application-test properties
    2 -> Yes, it can be accessed simply by using localhost:8080/h2-console. The H2 database is one of the most popular in-memory databases written in Java.
